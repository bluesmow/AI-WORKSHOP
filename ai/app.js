const app_id = "bd7e9f68"
const app_key ="8b1a66e9964bc4c6d8151b2f228631b7"	
...
const get_recipe = async () => {
           ...
           const response = await fetch(
                      `https://api.edamam.com/api/recipes/v2?type=public&q=${input.value}&app_id=${app_id}&app_key=${app_id}`
           );
